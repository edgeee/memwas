<template>
  <div>
    <div class="my-gallery image-container" itemscope itemtype="http://schema.org/ImageGallery">
      ...
      <figure
        ...
        <a :href="item.src" itemprop="contentUrl" :data-size="'' + item.w + 'x' + item.h" :title="item.title">
          <img :src="item.thumbnail" :alt="item.alt" itemprop="thumbnail" class="gallery-photo" />
        </a>
      </figure>
    </div>
